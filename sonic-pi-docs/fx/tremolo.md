...
### phase:
- **Descripción**: Phase duration in beats of tremolo modulation.
- **Default**: 4
...
### wave:
- **Descripción**: Wave type - 0 saw, 1 pulse, 2 triangle, 3 sine, 4 cubic. Different waves will produce different tremolo modulation effects.
- **Default**: 2
- **Restricciones**: must be one of the following values: [0, 1, 2, 3, 4]
- Puede cambiarse mientras se reproduce

### invert_wave:
- **Descripción**: Invert tremolo control waveform (i.e. flip it on the y axis). 0=uninverted wave, 1=inverted wave.
- **Default**: 0
- **Restricciones**: must be one of the following values: [0, 1]
- Puede cambiarse mientras se reproduce

### depth:
- **Descripción**: Tremolo depth - greater depths produce a more prominent effect.
- **Default**: 0.5
- **Restricciones**: must be a value between 0 and 1 inclusively
- Puede cambiarse mientras se reproduce
- Tiene parámetros de slide para dar forma a los cambios
