...
### distort:
- **Descripción**: Amount of distortion to be applied (as a value between 0 and 1)
- **Default**: 0.5
- **Restricciones**: must be a value greater than or equal to 0, must be a value less than 1
- Puede cambiarse mientras se reproduce
- Tiene parámetros de slide para dar forma a los cambios
