...
### output:
- **Descripción**: Sound card output to send audio to. Indexing starts at 1, so the third output is output 3.
- **Default**: 1
- Puede cambiarse mientras se reproduce

### mode:
- **Descripción**: Output mixing mode. 0 is a mixed-down mono version of the stereo input, 1 is the left channel only, 2 is the right channel only.
- **Default**: 0
- Puede cambiarse mientras se reproduce
