...
### amp_min:
- **Descripción**: Minimum amplitude value
- **Default**: 0
- No puede cambiarse una vez establecido
- Tiene parámetros de slide para dar forma a los cambios

### amp_max:
- **Descripción**: Maximum amplitude value
- **Default**: 1
- No puede cambiarse una vez establecido
- Tiene parámetros de slide para dar forma a los cambios
...
### pan_min:
- **Descripción**: Minimum pan value (-1 is the left speaker only)
- **Default**: -1
...
### pan_max:
- **Descripción**: Maximum pan value (+1 is the right speaker only)
- **Default**: 1
- **Restricciones**: must be a value between -1 and 1 inclusively
- Puede cambiarse mientras se reproduce
- Tiene parámetros de slide para dar forma a los cambios
