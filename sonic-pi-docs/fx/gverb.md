...
### spread:
- **Descripción**: Stereo spread. Amount of stereo spread the reverb has over the left and right channels. A value of 0 means no spread at all - left and right stereo values of the incoming signal are preserved. A value of 1 means full spread - the left and right channels are fully mixed within the reverb - bleeding into each other.
- **Default**: 0.5
- **Restricciones**: must be a value between 0 and 1 inclusively
- Puede cambiarse mientras se reproduce
- Tiene parámetros de slide para dar forma a los cambios
...
### damp:
- **Descripción**: High frequency rolloff. 0 is no damping (the reverb will ring out more) and 1 dampens the reverb signal completely
- **Default**: 0.5
- **Restricciones**: must be a value between 0 and 1 inclusively
- Puede cambiarse mientras se reproduce
- Tiene parámetros de slide para dar forma a los cambios
...
### pre_damp:
- **Descripción**: High frequency rolloff of input signal. 0 is no damping (the reverb will ring out more) and 1 dampens the reverb signal completely
- **Default**: 0.5
- **Restricciones**: must be a value between 0 and 1 inclusively
- Puede cambiarse mientras se reproduce
- Tiene parámetros de slide para dar forma a los cambios
...
### dry:
- **Descripción**: Amount of original dry signal present in the effect. This is distinct from mix.
- **Default**: 1
...
### room:
- **Descripción**: The room size in squared metres
- **Default**: 10
- **Restricciones**: must be a value greater than or equal to 1
- Puede cambiarse mientras se reproduce

### release:
- **Descripción**: Time for reverberation to complete in seconds
- **Default**: 3
- **Restricciones**: must be a value greater than 0
- Puede cambiarse mientras se reproduce

### ref_level:
- **Descripción**: Reflection level
- **Default**: 0.7
- **Restricciones**: must be a value greater than or equal to 0
- Puede cambiarse mientras se reproduce

### tail_level:
- **Descripción**: Tail level amount
- **Default**: 0.5
- **Restricciones**: must be a value greater than or equal to 0
- Puede cambiarse mientras se reproduce
