...
### freq:
- **Descripción**: Centre frequency of the band in MIDI notes.
- **Default**: 100
...
### res:
- **Descripción**: Width of the band as a value between 0 and 1
- **Default**: 0.6
...
### db:
- **Descripción**: Amount of boost or attenuation of the frequency band. A positive value boosts frequencies in the band, a negative value attenuates them.
- **Default**: 0.6
- Puede cambiarse mientras se reproduce
- Tiene parámetros de slide para dar forma a los cambios
