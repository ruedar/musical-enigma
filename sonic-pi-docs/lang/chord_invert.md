...
<tr>
<td><pre><code>play (chord_invert (chord :A3, "M"), 0)
sleep 1
play (chord_invert (chord :A3, "M"), 1)
sleep 1
play (chord_invert (chord :A3, "M"), 2)</code></pre></td>
<td>#No inversion     - (ring 57, 61, 64)<br>
 <br>
#First inversion  - (ring 61, 64, 69)<br>
 <br>
#Second inversion - (ring 64, 69, 73)</td>
</tr>
</table>
