...
<tr>
<td><pre><code>use_sched_ahead_time 1</code></pre></td>
...
<td># Each thread can have its own sched ahead time<br>
 <br>
 <br>
# Note 70 will be played with 1 second latency<br>
 <br>
 <br>
 <br>
# Note 70 will be played with 0.5 second latency</td>
</tr>
</table>
