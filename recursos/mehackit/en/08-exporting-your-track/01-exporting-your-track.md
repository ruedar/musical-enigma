...
When you’re happy with your track you might want to save the track as an audio file and share it with your friends online (for example, on your [SoundCloud](http://www.soundcloud.com/mehackit) page). First, you’ll need to record your song by using the record function in Sonic Pi.
...
Once you have your audio file saved you are ready to play and share it. However, we recommend you to process your audio file a little bit to make it sound more professional and louder. For this, we are going to use *Audacity* which is a free, open-source software for recording and Editing sounds. You can download *Audacity* (for Windows, Linux and OS X) from here: [http://www.audacityteam.org/download/](http://www.audacityteam.org/download/) .
...
![image](https://sonic-pi.mehackit.org/assets/img/audio_tutorial_04.jpg)

Now navigate to the “Effect” menu and select “Truncate Silence”.

![image](https://sonic-pi.mehackit.org/assets/img/audio_tutorial_05.jpg)
...
![image](https://sonic-pi.mehackit.org/assets/img/audio_tutorial_06.jpg)

Now you should see the silent parts of the audio removed from the waveform.

## Audacity: Normalizing loudness

![image](https://sonic-pi.mehackit.org/assets/img/audio_tutorial_07.jpg)
...
![image](https://sonic-pi.mehackit.org/assets/img/audio_tutorial_08.jpg)
...
![image](https://sonic-pi.mehackit.org/assets/img/audio_tutorial_09.jpg)

Now you should see that the spikes in the waveform are taller which means that the resulting audio is louder as well.

![image](https://sonic-pi.mehackit.org/assets/img/audio_tutorial_10.jpg)
...
![image](https://sonic-pi.mehackit.org/assets/img/audio_tutorial_11.jpg)
...
![image](https://sonic-pi.mehackit.org/assets/img/audio_tutorial_12.jpg)
