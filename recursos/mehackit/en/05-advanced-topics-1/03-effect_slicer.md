...
Now let’s add the slicer effect to the `live_loop` by using the familiar `with_fx` command. If you don’t remember or know how the effects are used in Sonic Pi, you can read more about them in the previous chapter called [Effects](https://sonic-pi.mehackit.org/exercises/en/03-tweak-the-sounds/03-effects.html) .
...
![image](https://sonic-pi.mehackit.org/assets/img/slicer_waveforms.png)
