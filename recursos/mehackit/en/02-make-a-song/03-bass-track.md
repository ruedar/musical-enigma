...
Add another live loop for your bass. Compose a solid and simple bass groove. If it helps, you can use the [piano](https://sonic-pi.mehackit.org/exercises/en/09-keys-chords-and-scales/01-piano.html) on your browser to choose notes that you like. Here’s an example:
...
![image](https://sonic-pi.mehackit.org/assets/img/attackrelease.png)
