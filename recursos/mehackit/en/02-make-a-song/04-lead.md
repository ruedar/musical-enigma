...
Create a new `live_loop` called `:melody` create a lead theme for your song. If it feels easier, use the `play_pattern_timed` function to write the melody. You can use the [piano](https://sonic-pi.mehackit.org/exercises/en/09-keys-chords-and-scales/01-piano.html) also if it helps. Here’s an example:
