...
If you don’t have Sonic Pi installed, go to [sonic-pi.net](http://sonic-pi.net/) , download and install Sonic Pi. It is available for Windows, OS X and Linux operating systems.
...
![image](https://sonic-pi.mehackit.org/assets/img/interface.png)
...
The numbers you used are *MIDI notes* . MIDI is a useful way to compose and is a useful tool for quickly 
